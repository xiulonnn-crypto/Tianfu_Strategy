...
def _sanitize_signal_history(data):
    ...
    actual_M、actual_invest、actual_bomb_pct、monthly_amount、signal_amount、bomb_signal_amount、bomb_actual_amount。"""
    _drop = ("actual_M", "actual_invest", "actual_bomb_pct",
             "monthly_amount", "signal_amount", "bomb_signal_amount", "bomb_actual_amount")
